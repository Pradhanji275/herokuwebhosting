...
import { stackParserFromStackParserOptions, logger, getGlobalObject, createStackParser, addRequestDataToEvent as addRequestDataToEvent$1, extractRequestData as extractRequestData$1 } from '@sentry/utils';
...
function addRequestDataToEvent(
  ...
  return addRequestDataToEvent$1(event, req, {
    ...options,
...
,
  ...
  // function lives
  return extractRequestData$1(req, { ...options, deps: { cookie, url } });
}

export { addRequestDataToEvent, close, defaultIntegrations, defaultStackParser, extractRequestData, flush, getSentryRelease, init, isAutoSessionTrackingEnabled, lastEventId };
