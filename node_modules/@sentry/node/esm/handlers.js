...
import { isString, extractTraceparentData, parseBaggageSetMutability, extractPathForTransaction, addRequestDataToTransaction, logger } from '@sentry/utils';
import * as domain from 'domain';
import { extractRequestData, isAutoSessionTrackingEnabled, flush, addRequestDataToEvent } from './sdk.js';
...
function tracingHandler()

 {
  return function sentryTracingMiddleware(
    ...
    var rawBaggageString = req.headers && isString(req.headers.baggage) && req.headers.baggage;
  ...
  return function sentryRequestMiddleware(
    ...
    local.run(() => {
      ...
      currentHub.configureScope(scope => {
        scope.addEventProcessor((event) => addRequestDataToEvent(event, req, options));
        var client = currentHub.getClient();
