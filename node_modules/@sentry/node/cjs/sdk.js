...
var stackParser = require('./stack-parser.js');
...
var defaultStackParser = utils.createStackParser(stackParser.nodeStackLineParser(module$1.getModule));
...
function addRequestDataToEvent(
  ...
  return utils.addRequestDataToEvent(event, req, {
    ...options,
...
,
  ...
  // function lives
  return utils.extractRequestData(req, { ...options, deps: { cookie, url } });
}
